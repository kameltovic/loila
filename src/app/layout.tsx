...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", locale: "fr_FR", siteName: SITE_NAME, images: [{ url: "/og/index.png", width: 1200, height: 630, type: "image/png" }] },
  twitter: { card: "summary_large_image", images: ["/og/index.png"] },
};
