...
const META: Record<ConventionCode, { slug: string; short: string }> = {
  ...
  "ccn-1702": { slug: "travaux-publics-ouvriers", short: "Travaux publics (ouvriers)" },
  ...
  "ccn-2420": { slug: "cadres-du-batiment", short: "Cadres du bâtiment" },
  "ccn-2596": { slug: "coiffure", short: "Coiffure" },
  "ccn-2609": { slug: "batiment-etam", short: "Bâtiment ETAM" },
