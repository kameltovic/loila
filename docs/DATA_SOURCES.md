...
| `npm run open-data:refs` | Référentiels servis par la prod, à relancer après déploiement : IDCC, juridictions compétentes (ministère de la Justice), zones tendues (décret 2013-392), IRL (INSEE, trimestriel). |
